...
Cannot handle Fire Emblem list:
  ...
  <ol>
  <li>For managing  multpile branches of fates <code>propose_to</code> and <code>respond_to</code> methods need to be able to handle non-existent preferences.</li>
